...
<head>
  ...
  <link rel="stylesheet" href="jsp/css/Projet_dp.css">
</head>
...
<body style="">
  ...
  <div class="text-center pb-5" style="	background-image: url(jsp/images/wallpaperflare.com_wallpaper.jpg);	background-size: cover;	background-position: top left;	background-repeat: repeat;">
    <div class="container text-center py-0 pb-5">
      ...
      <div class="row justify-content-center pt-5">
        <div class="tab-content">
          <div id="contentAccueil" class="tab-pane fade in active show">
            <div class="bg-white mx-auto col-12 col-md-12 p-5">
              <h3 class="display-2">Anti Covid</h3><img class="d-block mx-auto" src="jsp/images/covid-main.png">
          ...
          <div id="contentConnexion" class="tab-pane fade in ">
            <div class="bg-white justify-content-center pl-5 pr-5 pt-5">
              <h1 class="mb-4">Connexion</h1>
              <form method="POST">
                <div class="form-group"> <input type="email" class="form-control" name="form9" placeholder="E-mail"> </div>
                <div class="form-group mb-3"> <input type="password" class="form-control ml-auto" placeholder="Mot de passe" name="form10"> </div>
                <button name="Button" value="Connexion" type="submit" class="btn btn-lg btn-outline-primary px-5 mr-2">Valider</button><a class="btn btn-lg px-5 pl-2 ml-2 btn-outline-warning text-warning" onclick="$('#first_tab').trigger('click')">Annuler</a>
              </form>
          ...
          <div id="contentInscription" class="tab-pane fade in">
            <div class="bg-white justify-content-center pl-5 pr-5 pt-5">
              <h1 class="mb-4">Inscription</h1>
              <form method="POST">
                <div class="form-group"> <input type="email" class="form-control" name="emailInput" placeholder="E-mail"> </div>
                <div class="form-group"> <input type="password" class="form-control" placeholder="Mot de passe" name="mdpInput"> </div>
                <div class="form-group"> <input type="text" class="form-control" name="nomInput" placeholder="Nom"> </div>
                <div class="form-group"> <input type="text" class="form-control" name="prenomInput" placeholder="Prénom"> </div>
                <div class="form-group"> <input type="date" class="form-control" name="dateInput" placeholder="Date de naissance"> </div>
                <button name="Button" value="Inscription" type="submit" class="btn btn-lg btn-outline-primary px-5 mr-2">Valider</button><a class="btn btn-lg px-5 pl-2 ml-2 btn-outline-warning text-warning" onclick="$('#first_tab').trigger('click')">Annuler</a>
              </form>
              <div class="row justify-content-center mt-3">
                <div class="justify-content-center pt-4">Déjà membre ?<a onclick="$('#second_tab').trigger('click')" href="#" class="btn btn-lg align-center btn-link d-flex text-secondary my-0 mx-2 mb-5">Connexion</a></div>
              </div>
            </div>
          </div>
        </div>
